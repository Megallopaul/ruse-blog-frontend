<template>
  ...
  <p>You can prevent the setting of cookies by adjusting the settings on your browser (see your browser Help for how to
  ...
  <p>In order to provide you with a great experience on this site we provide the functionality to set your preferences
  ...
  <p>Email: mathilde@ruse-paris.fr</p>
</template>
<script setup>
useHead({
